    ...
    <div className="animate-fade-in rh-ext-page">
      ...
      <div className="page-header flex-between finance-page-header">
        ...
        <div className="finance-page-actions finance-page-actions--duo">
          ...
          >
            <Plus size={14} /> <span className="rh-ext-btn-label-full">Correction exceptionnelle</span><span className="rh-ext-btn-label-short">Correction</span>
          </button>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="card rh-ext-empty-state" style={{ textAlign: 'center', padding: 48, color: 'var(--text-3)' }}>
          <Building2 size={28} style={{ margin: '0 auto 8px', opacity: 0.4 }} />
          <p style={{ margin: '0 0 6px', fontWeight: 600 }}>{filterSemaine ? 'Aucune situation pour cette semaine' : 'Aucune situation enregistrée'}</p>
          <p style={{ margin: '0 0 12px', fontSize: '0.82rem' }}>
            Synchronisez depuis les présences pour générer les lignes.
          </p>
          <button type="button" className="btn btn-secondary" onClick={handleSync} disabled={syncing} style={{ minHeight: 44 }}>
        ...
        <div className="rh-ext-modal-overlay">
          <div className="card rh-ext-modal-box">
            <div className="flex-between" style={{ marginBottom: 16, flexWrap: 'wrap', gap: 8 }}>
              <div>
                <button type="button" className="rh-ext-back-btn" onClick={() => setShowModal(false)} aria-label="Retour aux paiements" style={{ marginBottom: 8 }}>
              ...
              <button type="button" onClick={() => setShowModal(false)} style={{ background: 'none', border: 'none', cursor: 'pointer', minWidth: 44, minHeight: 44 }} aria-label="Fermer"><X size={18} /></button>
            </div>
