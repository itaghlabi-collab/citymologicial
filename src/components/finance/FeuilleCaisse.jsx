...
export default function FeuilleCaisse() {
  ...
  const dailyTotals = useMemo(
    () => (activeDayDate ? computeDailyCashTotals(cashSheetRecords, balance, activeDayDate) : null),
    [cashSheetRecords, balance, activeDayDate],
  );
      ...
      <div className="page-header flex-between finance-page-header">
        ...
        <div className="finance-page-actions">
          ...
          <button
            ...
            onClick={() => exportCashSheetPdf({ year, month, transactions: cashSheetRecords, totals, balance })}
