-- =============================================================================
-- CITYMO ERP — ÉTAPE 4 : Sauvegardes opérationnelles (sauvegarde COMPLÈTE)
-- Supabase SQL Editor → Coller tout → Run
-- Prérequis : is_super_admin() + table erp_backups (ÉTAPE 1)
-- =============================================================================
...
-- ─── Helper : liste TOUTES les tables public (export complet backend) ────────
