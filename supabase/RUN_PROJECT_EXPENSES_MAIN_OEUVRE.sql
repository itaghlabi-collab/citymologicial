...
-- Idempotent : élargit le CHECK origine sans supprimer de données.
-- À coller dans le SQL Editor Supabase (une fois).
...
SELECT 'project_expenses.origine main_oeuvre OK' AS status;
