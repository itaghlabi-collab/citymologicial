-- CITYMO — Achats Module 1 : Fournisseurs (purchase_suppliers)
-- Exécutable dans Supabase SQL Editor — sans DROP / TRUNCATE / DELETE
...
-- Migration douce depuis achat_suppliers (si table legacy présente, sans suppression)
DO $migrate$
BEGIN
  IF EXISTS (
