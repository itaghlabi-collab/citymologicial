-- CRM Archives — import PDF historique (devis / factures legacy)
-- Ne modifie pas crm_devis ni crm_factures ; table dédiée + stockage citymo-documents/crm/archives/
...
-- Permissions RBAC (commercial + super_admin)
