...
-- RPC dédié Dépenses générales : contourne la RLS projects si besoin
...
COMMENT ON FUNCTION public.list_projects_for_charges_select() IS
  'Liste projets pour le select « Projet lié » du module Dépenses générales (charges).';
