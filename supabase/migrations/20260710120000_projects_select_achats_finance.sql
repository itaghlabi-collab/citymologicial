...
-- (ex. « Projet lié » dans demandes d'achat — Laila WOTFI, responsable achats)
...
-- RPC Achats : liste projets pour « Projet lié » (contourne RLS module Projets)
...
COMMENT ON FUNCTION public.list_projects_for_purchase_select() IS
  'Liste projets pour select « Projet lié » (demandes d''achat, achats groupés).';

-- RPC Finance : aligner sur les mêmes droits
