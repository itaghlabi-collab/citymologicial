...
-- Additive, isolé, non destructif. Aucune table existante n'est renommée ni vidée.
-- Exécuter aussi via supabase/RUN_FABRICATION.sql dans le SQL Editor si besoin.
...
-- Droits des sous-rubriques Fabrication (inserts uniquement, aucun droit existant modifié)
DO $$
DECLARE
  r RECORD;
  sub TEXT;
